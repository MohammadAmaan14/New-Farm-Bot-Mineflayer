...
const initBot = () => {
    ...
    bot.on('kicked', (reason, loggedIn) => {
      if (reason.text === 'The same username is already playing on the server!') {
          console.log('Received error: The same username is already playing on the server!');
          console.log('Reconnecting in 10 seconds...');
          setTimeout(initBot, 10000); // Retry after 10 seconds
      } else {
